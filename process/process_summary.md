...
The goal for this stage is clarity, maturation, and balancing. Mead can be damaged by improper storage and handling at this phase (see [bulk aging](//process/aging#wiki_bulk_aging) for more details). Use best practices will ensure the longest lifespan and highest flavor potential for your mead.
